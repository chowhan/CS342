...
class FConvNetModel(nn.Module):
	...
	def __init__(self):
		...
		self.upconv1 = nn.ConvTranspose2d(512, 256, 5, 3, 2, 1)
		self.upconv2 = nn.ConvTranspose2d(256, 128, 5, 3, 2, 1)
		self.upconv3 = nn.ConvTranspose2d(128, 64, 5, 3, 2, 1)
		self.upconv4 = nn.ConvTranspose2d(64, 32, 5, 3, 2, 1)
		self.upconv5 = nn.ConvTranspose2d(32, 3, 5, 3, 1)
