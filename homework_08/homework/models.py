...
class FConvNetModel(nn.Module):
	...
	def __init__(self):
		...
		self.upconv1 = nn.ConvTranspose2d(512, 256, 5, 2, 1)
		self.upconv2 = nn.ConvTranspose2d(256, 128, 5, 2, 1)
		self.upconv3 = nn.ConvTranspose2d(128, 64, 5, 2, 1)
		self.upconv4 = nn.ConvTranspose2d(64, 32, 5, 2, 1)
		self.upconv5 = nn.ConvTranspose2d(32, 3, 4, 2)
	...
	def forward(self, image, labels):
		...
		u1 = self.upconv1(c5)
		u2 = self.upconv2(c4 + c4)
		u3 = self.upconv3(u1 + c3)
		u4 = self.upconv4(u2 + c2)
		u5 = self.upconv5(u3 + c1)
